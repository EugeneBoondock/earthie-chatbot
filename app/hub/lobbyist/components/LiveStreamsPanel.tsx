...
export default function LiveStreamsPanel({ user }: { user: any }) {
  ...
  return (
    <div className="mt-6 mb-8 rounded-2xl bg-gradient-to-br from-sky-900/80 to-indigo-900/80 border border-sky-400/20 shadow-xl p-4 relative overflow-hidden">
      ...
      {pastStreams.length > 0 && (
        <div className="mt-2 pt-4 border-t border-sky-400/10">
